# This file is a modified version of https://github.com/Tsingularity/dift/blob/main/src/models/dift_sd.py.
...
class SDFeaturizer:
  ...
  @torch.no_grad()
  def forward(self, img_tensor, prompt=None, t=261, up_ft_index=1, ensemble_size=8):
    """
    Args:
...
# class DiftBackbone(torch.nn.Module):
#   def __init__(self, prompt, t, ):
#     super().__init__()
